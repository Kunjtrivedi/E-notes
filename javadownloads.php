...
<div class="java">
 <a >
 <img src="java1.jpg" width="50" height="50"  alt="" loading="lazy">
 OOP (JAVA)</a>
</div>
<div class="new">
  ...
  <tbody>
  <?php 
  $query = "SELECT * FROM usersubjectdocument where SubjectName='OOP(JAVA)'";
  ...
  while ($file = mysqli_fetch_array($query_run)) {
    ...
    <tr>
      ...
      <td><a type="button" class="btn btn-success btn-lg"  href="javadownloads.php?file=<?php echo $file['ID'] ?>">Download</a></td>
