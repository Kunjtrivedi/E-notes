...
<div class="dlcoa">
 <a >
 <img src="dlcoa.jpg" width="50" height="50"  alt="" loading="lazy">
 DIGITAL LOGIC & COMPUTER ORGANISATION AND ARCHITECTURE</a>
</div>
<div class="new">
  ...
  <tbody>
  <?php 
  $query = "SELECT * FROM usersubjectdocument where SubjectName='DLCOA'";
  ...
  while ($file = mysqli_fetch_array($query_run)) {
    ...
    <tr>
      ...
      <td><a type="button" class="btn btn-success btn-lg"  href="dlcoadownloads.php?file=<?php echo $file['ID']; ?>">Download</a></td>
