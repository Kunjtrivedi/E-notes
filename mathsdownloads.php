...
<head>
  ...
  <title>ENGINEERING MATHS-3</title>
</head>
<body>
...
<div class="new3">
 <a >
 <img src="maths.jpg" width="50" height="50"  alt="" loading="lazy">
...
<div class="new">
  ...
  <tbody>
  <?php 
  $query = "SELECT * FROM usersubjectdocument where SubjectName='EM-3'";
  ...
  while ($file = mysqli_fetch_array($query_run)) {
    ...
    <tr>
      ...
      <td><a type="button" class="btn btn-success btn-lg"  href="mathsdownloads.php?file=<?php echo $file['ID'] ?>">Download</a></td>
